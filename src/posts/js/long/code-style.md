...
Prettier при сохранении превращает «сырой» код (1 на примере ниже) в код с форматированием (2). Это автоматически исключает возможность неправильной интерпретации кода.
...
Автоматические форматтеры [снимают с разработчиков головную боль форматирования кода](/js/tools/static-analysis/):
...
Договариваться о стиле коде — это спорить о вкусах. Не всегда можно привести объективные аргументы в пользу любимого стиля. Точка с запятой влияет на интерпретацию, а вот табы или пробелы — нет. В любом случае, лучше один раз договориться на старте проекта, чем потом каждый раз спорить в комментариях к ревью.
